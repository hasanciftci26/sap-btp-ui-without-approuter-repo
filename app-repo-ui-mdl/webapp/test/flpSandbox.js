		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ntttestapprepouimdl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntttestapprepouimdl-display": {
								"semanticObject": "ntttestapprepouimdl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ntt.test.apprepouimdl",
									"url": sap.ui.require.toUrl("ntt/test/apprepouimdl")
								}
							}
						}
					}
